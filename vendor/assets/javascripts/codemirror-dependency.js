...
CodeMirror.defineMIME('text/x-coffeescript', 'coffeescript');CodeMirror.defineMode("css", function(config) {
...
CodeMirror.defineMIME("text/html", "htmlmixed");// TODO actually recognize syntax of TypeScript constructs
...
CodeMirror.defineMIME("application/typescript", { name: "javascript", typescript: true });CodeMirror.defineMode("markdown", function(cmCfg, modeCfg) {
...
CodeMirror.defineMIME("text/x-markdown", "markdown");CodeMirror.defineMode("ruby", function(config) {
...
CodeMirror.defineMIME("text/x-sass", "sass");CodeMirror.defineMode("skim", function(config) {
  var tokenRegexp = function(words){
    return new RegExp("^" + words.join("|"));
  };
